...
userPopUp.setAttribute('id', 'userPopUp');
userPopUp.style.width = '90%';
userPopUp.style.height = '90%';
userPopUp.style.border = '5px solid yellow';
userPopUp.style.backgroundColor = 'blue';
userPopUp.style.zIndex = '1000';
userPopUp.style.left = '5%';
userPopUp.style.top = '5%';
userPopUp.style.borderRadius = '10px';
userPopUp.style.position = 'absolute';
userPopUp.style.opacity = '.9';
userPopUp.style.display = 'none';

let innerUserPopUp = document.createElement('div');
innerUserPopUp.style.width = '100%';
innerUserPopUp.style.height = '5%';
innerUserPopUp.style.backgroundColor = 'black';
innerUserPopUp.style.display = 'flex';
innerUserPopUp.style.justifyContent = 'right';

let innerUserTitle = document.createElement('div');
let UserContentTitle = document.createElement('h1');
UserContentTitle.innerHTML = 'create new user';
UserContentTitle.style.color = 'white';
UserContentTitle.style.fontSize = '30px';
// innerUserTitle.style.width = '100%';
innerUserTitle.style.position = 'relative';
// innerUserTitle.style.display ='flex';
innerUserTitle.style.justifyContent = 'center';
// innerUserTitle.style.alignContent = 'center';
// innerUserTitle.style.justifyItems = 'center';
// innerUserTitle.style.alignItems = 'center';
// innerUserTitle.style.alignText = 'center';
innerUserTitle.style.left = '10%';
// UserContentTitle.style.transform = 'translateX(50%)';

// UserContentTitle.style.width = '100%';
UserContentTitle.style.height = '10%';


innerUserTitle.appendChild( UserContentTitle);

let contentAreaUserPopUp = document.createElement('div');

contentAreaUserPopUp.style.width = '90%';
contentAreaUserPopUp.style.height = '90%';
contentAreaUserPopUp.style.border = '4px solid white';
contentAreaUserPopUp.style.justifyContent = 'center';


let InnercontentArea = document.createElement('div');
InnercontentArea.style.width = '100%';
InnercontentArea.style.height = '100%';
InnercontentArea.style.border = '4px solid white';
// InnercontentArea.style.display = 'flex';
InnercontentArea.style.backgroundColor = 'purple';
InnercontentArea.style.justifyContent = 'center';
InnercontentArea.style.left = '10%';

contentAreaUserPopUp.style.left = '5%';
contentAreaUserPopUp.style.position = 'relative';
...
//    container.style.display='inline-flex';
   ...
   container.appendChild(input);
    ...
    form.setAttribute('id', 'createNewUserForm');
}
////////////////////////
...
InnercontentArea.appendChild(form);

///////////////////////////////////////END FORM
contentAreaUserPopUp.appendChild( InnercontentArea);
...
innerUserContent.appendChild( innerUserTitle);
// innerUserContent.appendChild( UserContentTitle);
innerUserContent.appendChild(contentAreaUserPopUp);
...
innerUserPopUp.appendChild(popUpCloseButton);
userPopUp.appendChild(innerUserPopUp);
userPopUp.appendChild(innerUserContent);
...
userJava.appendChild(userPopUp);
...
function toggleDisplay(element) {
    ...
    // tempContainere.innerHTML += 'oooooh jamaaaaannn'+item.name +' '+item.id;
});
...
//////////////////////////////////////////////  BEGIN POPUP BUTTON
innerUserPopUp.addEventListener('click',function (event) {
    event.preventDefault();
    let popup = document.getElementById('userPopUp');

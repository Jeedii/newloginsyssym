...
options.forEach((option, index) => {
    ...
    label.setAttribute('for', `${adisi.type}checkbox${index + 1}`);
...
submitButton.addEventListener('click',function (event) {
    ...
    let formdata  = document.getElementById(adisi.type+'createNewUserForm');
...
innerTitleContainer.setAttribute('id', adisi.type+'innerTitleConta');
titleContainer.appendChild(innerTitleContainer); 


let userPlus= document.createElement("p");
userPlus.setAttribute('id', adisi.type+'userPlus');
userPlus.innerHTML = '+';
...
userHeader.setAttribute('id', adisi.type+'userHeada');
...
tempContainere.setAttribute('id', adisi.type+'tysy');
...
appz.forEach(function(item, index) {
  ...
  expandButton.setAttribute('id', adisi.type+'expandButton'+ index);
  expandButton.innerHTML = '0';

        userTable = document.createElement("table");
        userTable.setAttribute('id', adisi.type+'user'+rws+'Table'+ index);
        userTable.style.width = '100%';
        userTable.style.height = '50px';
...
//////////////////////////END  CASE 0
    ...
    if(rws == '1'){
        ...
        aTDs = 6;
           userTable = document.createElement("table");
           userTable.setAttribute('id', adisi.type+'userExpandTable'+ index);
           userTable.style.width = '100%';
...
let expansionTable =document.getElementById(adisi.type+'userExpandTable'+strippedIndex[1]);
...
// Rasengan.addEventListener('click', function (event) {
    ...
    $(document).ready(function () {
        let typeString = 'xUsersx'
        let PagesClassy = new PagesClass('TESTaPPZ',typeString);
...
let userPlusButton  = document.getElementById(typeString+'userPlus');
userPlusButton.addEventListener('click',function (event) {
    event.preventDefault();
    
    let popup = document.getElementById(typeString+'userPopUp');

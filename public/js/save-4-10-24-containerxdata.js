...
deleteButtonZ.addEventListener('click',function (event) {
    event.preventDefault();
console.log('theseare the crudButtons deleteButtonZ',event,event.target.innerHTML)
  })

  editButtonZ.addEventListener('click',function (event) {
    event.preventDefault();
console.log('theseare the crudButtons editButtonZ',event,event.target.innerHTML)
  })
...
<li>${adisi_CDLC.ParentcontainerClass.appz[yy].container_naam}</li>\
<li>${adisi_CDLC.ParentcontainerClass.appz[yy].id}</li>\
<li>${adisi_CDLC.ParentcontainerClass.appz[yy].container_inhoud}</li>\
<li>${adisi_CDLC.ParentcontainerClass.appz[yy].container_formaat}</li>\
<li>${adisi_CDLC.ParentcontainerClass.appz[yy].date_ophaalcontainer}</li>\
<li>${adisi_CDLC.ParentcontainerClass.appz[yy].status}</li>\
...
// adisi_CDLC.ParentcontainerClass.appz[yy].container_naam
adisi_CDLC.layoutInnerTD.insertAdjacentHTML('beforeEnd', (`<ul id="unorderedListerz" style="float:right;  color:white; text-align:right; margin:0px 10px;">\
<li>${adisi_CDLC.ParentcontainerClass.appz[yy].date_vertrek}</li>\
<li>${adisi_CDLC.ParentcontainerClass.appz[yy].locatie_vertrek_container}</li>\
<li>${adisi_CDLC.ParentcontainerClass.appz[yy].date_aankomst_bestemming}</li>\
<li>${adisi_CDLC.ParentcontainerClass.appz[yy].locatie_bestemming}</li>\
<li>${adisi_CDLC.ParentcontainerClass.appz[yy].vaart_id}</li>\
<li>${adisi_CDLC.ParentcontainerClass.appz[yy].status}</li>\
<li>${adisi_CDLC.ParentcontainerClass.appz[yy].notitie}</li>\
<li>${adisi_CDLC.ParentcontainerClass.appz[yy].status}</li>\
...
adisi_CDLC.layoutOuterDiv.appendChild( adisi_CDLC.layoutInnerDiv );
    ...
    // adisi_CDLC.userJava.appendChild(adisi_CDLC.layoutOuterDiv);
        ...
        console.log('here you areCCC','adisi_CDLC','aapa','aapa','this.ParentcontainerClass', adisi_CDLC.ParentcontainerClass.appz);

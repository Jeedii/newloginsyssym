...
"https://cdnjs.cloudflare.com/ajax/libs/screenfull.js/3.1.0/screenfull.min.js">
    ...
    <script type="text/javascript" src="/js/phaser-files/game.js" ></script>
        ...
        <script type="text/javascript" class="dynamic-script" src="{{asset('js/app.js')}}" ></script>
    </head>
    <body >
...
*/ -->
        ...
        <p id="reloaderContent" style="z-index:9999; color:white; margin:10px;"> Zaap {{ Route::currentRouteName() }} </p>

        <p id="reloaderContentu" style="z-index:9999; color:white; margin:10px;"> Maap {{ Route::currentRouteName() }} </p>
